...
- Post-generation prompt embedding for generated LLM workflows.
...
LLM workflows are generated by `scripts/build_llm_workflows.py`, patched by `scripts/embed_llm_prompts.py`, and include live OpenAI/LiteLLM HTTP Request nodes plus explicit `mode: dry_run` fallback.
